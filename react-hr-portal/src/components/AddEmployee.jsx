...
function AddEmployee() {
  ...
  let addEmployee = async (event) => {
    ...
    if (employeePresent === undefined) {
      ...
      setMsg("✅ Employee was added successfully");
    } else {
      setMsg("❌ Employee is already present");
    }
    ...
    <div className="add-employee-container">
      <div className="add-employee-card">
        <div className="card-header-block">
          ...
          <h2>Add Employee</h2>
          <p>Register a new team member so they can complete signup and access the portal.</p>
        </div>
