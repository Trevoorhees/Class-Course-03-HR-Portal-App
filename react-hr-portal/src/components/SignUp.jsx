...
function SignUp() {
  ...
  let verifyEmailId = async (event) => {
    ...
    if (employeePresent === undefined) {
      setMsg("❌ Email Id not registered with the company. Please contact HR");
      setEmailId("");
    } else {
      setFlag(false);
  ...
  let signUp = async (event) => {
    ...
    setMsg("✅ Sign Up successful. Please login to continue");
    ...
    <div className="signup-container">
      <div className="signup-card">
        <div className="signup-header">
          <p className="section-kicker">Employee Onboarding</p>
          <h2>Complete your account setup</h2>
          <p>
            Verify your company email first, then finish registration with your account details.
          </p>
        </div>
